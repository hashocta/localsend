                ...
                children: [
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(t.sendTab.selection.files(files: vm.selectedFiles.length), style: TextStyle(color: Colors.white)),
                            Text(t.sendTab.selection.size(size: vm.selectedFiles.fold(0, (prev, curr) => prev + curr.size).asReadableFileSize), style: TextStyle(color: Colors.white)),
                    ...
                    children: [
                      ...
                      Flexible(
                        child: Padding(
                          ...
                          child: Text(t.sendTab.nearbyDevices, style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white)),
                        ),
                      ),
                  ...
                  Center(
                    child: TextButton(
                      ...
                      child: Text(t.troubleshootPage.title, style: TextStyle(color: Colors.white)),
                    ),
                  ),
                  const SizedBox(height: 20),
                ],
